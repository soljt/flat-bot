...
class TestRunCycle:
    def test_new_match_is_notified_and_marked(self, tmp_path, monkeypatch):
        ...
        monkeypatch.setattr("flatbot.pipeline.generate_email", lambda l, k, p=None, s=None: ("Sub", "Body"))
    ...
    def test_cross_platform_dedup_sends_once(self, tmp_path, monkeypatch):
        ...
        monkeypatch.setattr("flatbot.pipeline.generate_email", lambda l, k, p=None, s=None: ("Sub", "<p>Body</p>"))
